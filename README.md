...
I have learned how to create a repo on GitHub and invite collaborators. 
I have learned how to clone a repo with VS Code using git clone command
I was able to create a local settings file named ".env.development."
